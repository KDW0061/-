...
//#define SLOW_DRIVE_SPEED       170
#define NORMAL_DRIVE_SPEED    170   //기본 speed
...
#define LINEDETECT_THRESHOLD_MIN 400  //라인 카운터 센서 값   (검정)
#define BLANKDETECT_THERSHOLD_MAX 250 // 흰색 센서 값         (흰색)

#define SERVO1_PUTDOWN_ANGLE 180 // MinDown
#define SERVO1_LIFTUP_ANGLE 90+0  // MaxUp+10
